...
Typically, you should setup an IAM policy, create a user and apply the IAM policy to the user or if your Logstash server is on EC2/ECS you can add the Policy to a Role.
